package learnJava.src.dersler.gun2;
...
//Task -> iki farklı tamsayı türünde sayı  tanımlayıp toplam ve farkını print ediniz
        int sayi1=10;
        double sayi2=20.500;
        System.out.printf("sayıların toplamı: %s%n", sayi1 + sayi2);
        char v = 'c';
        System.out.println(v + "x" + sayi1);
        System.out.println(sayi1 + "x" + v);
        System.out.println(sayi1 + v + "x");
