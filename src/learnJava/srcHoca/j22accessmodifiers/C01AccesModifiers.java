package learnJava.srcHoca.j22accessmodifiers;

public class C01AccesModifiers {      /*
     1)public
     2)protected
     3)default
     4)private
    ...
    private C01AccesModifiers() {
        System.out.println("p'siz const run edildi");
    }

    public C01AccesModifiers(int ilkYas, int sonYas) {
    ...
    public static void main(String[] args) {
        C01AccesModifiers obj1 = new C01AccesModifiers();
    }
}