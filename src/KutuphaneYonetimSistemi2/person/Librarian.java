package KutuphaneYonetimSistemi2.person;
...
public class Librarian extends Person {
    ...
    public Librarian(String name,String surname, String contactInfo, String email, String department) {
        ...
        this.employeeId = "L" + super.getId();   //Librarian için super constructorda üretilen final id değerine, E harfi eklenerek employee için de specific final id üretir
    }
